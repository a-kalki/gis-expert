...
С программой обучения вы можете ознакомиться на вкладке: "TypeScript" или "Python" в зависимости от того какой стек вас интересует.
...
Читая дальше можешь обратить внимание, что я обращаюсь на ты. Это сделано намеренно, так как одна из задач курсов является: обучение командному взаимодействию. Приглашая на курсы, я приглашаю в свою команду.
...
Хочешь узнать и более того практиковать agile? Приходи на курсы. Как видишь из этих строк, на курсах ты научишься больше чем просто программированию!

## О курсах

Называю это курсами, потому что так понятнее, но это скорее менторство. Наша цель обучиться не ради бумаги или сертификата, а ради настоящих навыков и опыта работы в команде.
...
Если вы закончили первый модуль и заряжены продолжать, значит мы на одном вайбе, свой человек. Снижаю для вас финансовую нагрузку.
...
А вы знали, что задача программиста — думать алгоритмически? Это значит, что любую человеческую задачу нужно уметь переводить в алгоритм.
...
Если станете программистом, вы быстро узнаете, что идеального кода не существует. За каждым решением стоят свои плюсы и минусы. Программист постоянно ищет компромиссы...
...
Если вы прочитали этот раздел и вам понятно, что здесь написано, то, вполне возможно, в вас сидит потенциал будущего программиста.

Что с этим делать? Выбор за вами...
