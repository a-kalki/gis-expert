...
Так как я ментор, то моя основная задача:
...
Я буду по максимуму в вас развивать командное взаимодействие, т.е. умение работать с другими людьми. Будьте готовы помогать другим, изучать их код, оценивать и давать обратную связь. И делать это вежливо). А еще не думайте что я на вас повесил свою работу по проверкам ДЗ. Это часть учебного процесса)!
...
Если вы живете в Уральске и нет возможности платить за обучение, то возможны варианты отработки обучения. Обращайтесь, обсудим.
...
После каждого модуля лучший студент получит бесплатный сертификат на следующий модуль. Лучшего студента будете определять вы сами.
